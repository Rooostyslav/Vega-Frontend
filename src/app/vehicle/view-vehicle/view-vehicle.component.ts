...
export class ViewVehicleComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.photoService.getPhoto(this.vehicle.id)
      .subscribe(photo => {
        ...
        //let objectURL = 'data:image/jpg;base64,' + photo.valueOf();
  ...
  createPhotoFromBlob(photoBlob: Blob) {

    //photoBlob.type = 'image/jpeg';
    return URL.createObjectURL(photoBlob) + '.jpeg';
  ...
  getDate(): string {
    if (this.vehicle.lastUpdate) {
      let date = new Date(this.vehicle.lastUpdate);
